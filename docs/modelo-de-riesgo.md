...
| El color de un indicador describe la cifra que ese indicador muestra | Un solo color no puede cargar dos hechos: "el promedio se pasó" pide reducir frecuencia y "un mal año te destruye" pide contener el daño; fusionados, el usuario no puede saber cuál es |
| El promedio en verde nunca va solo                                   | Separar promedio y cola recupera información pero abre el riesgo de que alguien vea verde y deje de leer; cuando la cola es peor, el mosaico del promedio lo dice                       |
